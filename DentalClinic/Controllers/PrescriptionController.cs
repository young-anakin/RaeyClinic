...
namespace DentalClinic.Controllers
{
    ...
    {
        private readonly IPrescriptionService1 _prescriptionService;
        public PrescriptionController(IPrescriptionService1 prescriptionService)
        {
            _prescriptionService = prescriptionService;
        }
        [HttpPost("AddPrescriptionService")]
        public async Task<ActionResult> AddPricingReason([FromBody] AddPrescriptionDTO prescriptionDTO)
        {
        ...
        public async Task<ActionResult> UpdatePrescription(UpdatePrescriptionDTO prescriptionDTO)
        {
            if (prescriptionDTO == null)
            {
                return BadRequest(new ErrorResponse { Message = "Prescription data cannot be null." });
        ...
        [HttpGet("GetPrescriptionData")]
        public async Task<ActionResult> GetPrescription()
        {
        ...
        [HttpGet("GetSpecificPrescription")]
        public async Task<ActionResult> GetSpecificPrescription(int id)
        {
        ...
        [HttpDelete("DeletePrescriptionData")]
