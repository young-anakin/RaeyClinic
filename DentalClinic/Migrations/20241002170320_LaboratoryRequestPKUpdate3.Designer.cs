...
namespace DentalClinic.Migrations
{
    ...
    [Migration("20241002170320_LaboratoryRequestPKUpdate3")]
    partial class LaboratoryRequestPKUpdate3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentalClinic.Models.Bacterology", b =>
                {
                    ...
                    b.HasOne("DentalClinic.Models.LaboratoryRequests", "LaboratoryRequest")
                        .WithOne("Bacterology")
                        .HasForeignKey("DentalClinic.Models.Bacterology", "LaboratoryRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DentalClinic.Models.Chemistry", b =>
                {
                    b.HasOne("DentalClinic.Models.LaboratoryRequests", "LaboratoryRequest")
                        .WithOne("Chemistry")
                        .HasForeignKey("DentalClinic.Models.Chemistry", "LaboratoryRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DentalClinic.Models.Hematology", b =>
                {
                    ...
                    b.HasOne("DentalClinic.Models.LaboratoryRequests", "LaboratoryRequest")
                        .WithOne("Hematology")
                        .HasForeignKey("DentalClinic.Models.Hematology", "LaboratoryRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DentalClinic.Models.Serology", b =>
                {
                    b.HasOne("DentalClinic.Models.LaboratoryRequests", "LaboratoryRequest")
                        .WithOne("Serology")
                        .HasForeignKey("DentalClinic.Models.Serology", "LaboratoryRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DentalClinic.Models.StoolExamination", b =>
                {
                    b.HasOne("DentalClinic.Models.LaboratoryRequests", "LaboratoryRequest")
                        .WithOne("StoolExamination")
                        .HasForeignKey("DentalClinic.Models.StoolExamination", "LaboratoryRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DentalClinic.Models.Urinalysis", b =>
                {
                    b.HasOne("DentalClinic.Models.LaboratoryRequests", "LaboratoryRequest")
                        .WithOne("Urinalysis")
                        .HasForeignKey("DentalClinic.Models.Urinalysis", "LaboratoryRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
